...
console.log("Welcome to The OmnipuppyXx BlockChain..." + ":——-::——–:" + datetime + ""); 
console.log("Please Wait While We Retrieve the Key Encryption and BlockChain Index" + ":——-::——–:" + datetime + ""); 	 

function intervalFunc() { console.log(''); var x=1; while (x!=0){ 	 
...
gen_hash= data.digest('hex'); var logo9 = gen_hash + "" + datetime + "" + "335253122353132313321BASE23522135311523133235BASE353253153323532313325BASE135323531321531523531BASE323153512352531353215BASE532313525355332333235BASE" ; 
...
this.hash = new this.calculateHash();
...
data = hash.update(logoRipe, 'utf-8'); 
gen_hash= data.digest('hex'); 
var logoRecache = gen_hash + "" + this.index, this.previousHash, this.timestamp, JSON.strigify(this.data)).toString();
...
function intervalFunc() { console.log("initializing..."); var crypto = require("crypto");function encrypt(key, str) {		var hmac = crypto.createHmac("sha512", key);	var signed = hmac.update(new Buffer(str, 'utf-8')).digest("base64");		console.log(signed);	 } } setInterval(intervalFunc, 1000);

	
 		
 	}
 	
 	class createGenisisBlock(){
 		
 		
 		return new Block(0, '21/01/2020', 'Genisis block', '0',  JSON.strigify(this.createHMAC3)).toString());
  ...
  class addBlock(newBlock){
 		...
 		let OmniPuppyXX_Coin = new Blockchain();
 	 OmniPuppyXX_Coin.addBlock(new Block((1, "22/01/2020", (amount: 4), this.datetime, JSON.strigify(this.createHMAC3)).toString()));
 	 OmniPuppyXX_Coin.addBlock(new Block((2, "23/01/2020", (amount: 4), this.datetime, JSON.strigify(this.createHMAC3)).toString()));
 	 
 	OmniPuppyXX_Coin.addBlock(new Block((3, "24/01/2020", (amount: 4), this.datetime, JSON.strigify(this.createHMAC3)).toString()));
 
 	OmniPuppyXX_Coin.addBlock(new Block((4, "25/01/2020", (amount: 4), this.datetime, JSON.strigify(this.createHMAC3)).toString()));
 	 OmniPuppyXX_Coin.addBlock(new Block((5, "26/01/2020", (amount: 4), this.datetime, JSON.strigify(this.createHMAC3)).toString()));
 	 
 	OmniPuppyXX_Coin.addBlock(new Block((6, "27/01/2020", (amount: 4), this.datetime, JSON.strigify(this.createHMAC3)).toString()));
...
} console.log(callStr.toString()); x++; }setInterval(intervalFunc, 1000); 